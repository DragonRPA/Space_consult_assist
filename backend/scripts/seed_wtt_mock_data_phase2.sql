...
-- (FK 제약조건 100% 독립 실행 가능하도록 직원 선행 등록 포함)
-- ==========================================================
...
VALUES 
('763b1141-1d94-4115-bebd-fce8df63a20f', 'e7777777-7777-7777-7777-777777777777', NULL, '접수', 'desktop', '2026-08-23 11:00:00+09', '11111111-1111-1111-1111-111111111111'),
('e5665cca-9e82-4ff4-bae9-a1aaaa0a70e5', 'e7777777-7777-7777-7777-777777777777', '접수', '진행중', 'mobile', '2026-08-23 13:30:00+09', '22222222-2222-2222-2222-222222222222'),
('dce14340-78eb-4e34-98e0-1f69b4b04eb0', 'e7777777-7777-7777-7777-777777777777', '진행중', '재방문', 'mobile', '2026-08-23 14:15:00+09', '22222222-2222-2222-2222-222222222222')
...
INSERT INTO visit_status_history (id, visit_id, old_status, new_status, client_type, changed_at, changed_by)
VALUES 
('e815f35b-ea2c-4dc8-ad11-05dac442d4ab', 'e8888888-8888-8888-8888-888888888888', NULL, '접수', 'desktop', '2026-08-23 12:00:00+09', '11111111-1111-1111-1111-111111111111'),
('3c89f046-fbf6-4d84-b08c-58fb3b999677', 'e8888888-8888-8888-8888-888888888888', '접수', '진행중', 'mobile_offline_sync', '2026-08-23 13:00:00+09', '33333333-3333-3333-3333-333333333333'),
('6bd15445-bbff-4701-9ea5-9bb6f16c9fcc', 'e8888888-8888-8888-8888-888888888888', '진행중', '완료', 'mobile_offline_sync', '2026-08-23 14:00:00+09', '33333333-3333-3333-3333-333333333333')
ON CONFLICT (id) DO NOTHING;
...
VALUES 
('4f9c99de-6ea8-4ecb-af6c-00e5f75f5041', 'd9999999-9999-9999-9999-999999999999', '물이 줄줄 새고 바닥이 흥건해요', 'AI추천: 급수 밸브 누수 -> 상담사교정: 오수탱크 하단 드레인 호스 크랙', false, '2026-08-23 14:30:05+09')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO visit_status_history (id, visit_id, old_status, new_status, client_type, changed_at, changed_by)
VALUES 
('84247bff-923d-4782-967e-6572b8ab7067', 'e1010101-1010-1010-1010-101010101011', NULL, '접수', 'desktop', '2026-08-09 10:00:00+09', '11111111-1111-1111-1111-111111111111'),
('66ce8f1f-3151-4f53-982d-c72aa7011733', 'e1010101-1010-1010-1010-101010101011', '접수', '진행중', 'mobile', '2026-08-09 13:00:00+09', '22222222-2222-2222-2222-222222222222'),
('c60ef5f8-b0f4-4a2f-9686-377a695cc519', 'e1010101-1010-1010-1010-101010101011', '진행중', '완료', 'mobile', '2026-08-09 15:30:00+09', '22222222-2222-2222-2222-222222222222'),

('6554ff37-2d53-445b-99d0-9917ae6022bd', 'e1010101-1010-1010-1010-101010101012', NULL, '접수(긴급격상)', 'desktop', '2026-08-23 15:00:00+09', '11111111-1111-1111-1111-111111111111')
ON CONFLICT (id) DO NOTHING;

-- 7. 2차 WTT 최소 감사 로그 (audit_log_minimal)
INSERT INTO audit_log_minimal (id, table_name, record_id, action, changed_by, changed_at)
VALUES 
('19b4414c-4d8d-4103-8cba-9c135dfb3235', 'visits', 'e7777777-7777-7777-7777-777777777777', 'REVISIT_STOCK_SHORTAGE', '22222222-2222-2222-2222-222222222222', '2026-08-23 14:15:00+09'),
('76216461-6983-4697-aac1-43f1736a0ec1', 'visits', 'e8888888-8888-8888-8888-888888888888', 'OFFLINE_SYNC_COMPLETE', '33333333-3333-3333-3333-333333333333', '2026-08-23 14:00:00+09'),
('4a30e95e-b94e-4b43-97c5-eb63f77dabee', 'consult_logs', 'd9999999-9999-9999-9999-999999999999', 'COUNSELOR_OVERRIDE', '11111111-1111-1111-1111-111111111111', '2026-08-23 14:30:00+09'),
('fc8f04dd-19bc-4f35-86aa-2f95cc2fb829', 'visits', 'e1010101-1010-1010-1010-101010101012', 'ESCALATE_REPEAT_BREAKDOWN', '11111111-1111-1111-1111-111111111111', '2026-08-23 15:00:00+09')
ON CONFLICT (id) DO NOTHING;
