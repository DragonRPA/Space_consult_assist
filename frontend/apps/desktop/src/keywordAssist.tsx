...
// 2. Comprehensive 4-Category Named Entity Registry (Zero Emoji, Professional Clean UI)
export const NAMED_ENTITY_REGISTRY: EntityRule[] = [
  ...
  },
  {
    ...
    type: 'symptom',
    label: '증상/부품',
    pattern: /스퀴지|바닥\s*물기|잔수|고무\s*블레이드|물\s*자국|고무패드|고무\s*패드|패드\s*거치대|고정판|판\s*거치대/i,
  ...
  // D. ACTION & SOP CHECKLIST TRIGGER (조치 / 점검 행동 - Emerald / Green)
  {
