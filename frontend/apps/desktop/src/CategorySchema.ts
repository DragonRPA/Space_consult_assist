...
export const WORKTYPE_OPTIONS: Record<string, string[]> = {
  'sales-demo': ['상담답사', '시연'],
  'equip-ship': ['긴급출고', '재출고', '출고', '출고예정'],
  'part-ship': ['부품', '부품예정', '소모', '소모예정'],
  'rental-ship': [
    '구독', '구독예정', '구독조기종료', '구독종료', '대체출고', '대체출고회수', 
    '렌탈', '렌탈예정', '렌탈조기종료', '렌탈종료', '시연출고', '시연출고회수', 
    '추가구독', '추가구독조기종료', '추가구독종료', '추가렌탈', '추가렌탈조기종료', '추가렌탈종료'
  ],
  'as-service': ['긴급수리', '수리입/출고', '수리입고', '수리출고', '재방문', '현장수리'],
  'purchase-check': ['매입', '매입실사'],
  'maintenance': ['렌탈점검', '유지보수', '일시점검', '정기점검'],
  'other': ['근태', '기타', '대여', '대여회수', '입고', '폐기회수'],
  'custom-id_8t03pasmt86cgqq': ['근태', '기타', '대여', '대여회수', '입고', '폐기회수'],
};
